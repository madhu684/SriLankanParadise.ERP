    ...
    <div className="container-fluid py-4" style={{ maxWidth: "1400px" }}>
      ...
      <div className="mb-4">
        ...
        <div className="text-center">
          <h1 className="fw-bold mb-2">Update Location</h1>
        </div>
        <hr className="my-4" />
      </div>
      ...
      {submissionStatus === "successSavedAsDraft" && (
        ...
        >
          <div className="d-flex align-items-center">
            ...
            <div>
              <strong>Saved!</strong> Location updated as inactive. You can edit
      ...
      {submissionStatus === "error" && (
        ...
        >
          <div className="d-flex align-items-center">
            ...
            <div>
              <strong>Error!</strong> Unable to update location. Please try
              again.
            </div>
          </div>
        </div>
                  ...
                  <div className="d-flex">
                    ...
                    <div>
                      ...
                      <p className="mb-0 small">
                        This location is set as a main location and can have
                        sub-locations under it.
                      </p>
                    </div>
                  </div>
                </div>
