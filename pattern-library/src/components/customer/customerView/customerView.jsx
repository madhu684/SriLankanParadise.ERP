    ...
    >
      ...
      <Modal.Body className="bg-light p-4">
        <Container fluid>
          ...
          {/* Delivery Addresses */}
          {customer.customerDeliveryAddress.length > 0 && (
            <Row className="mb-4">
              <Col xs={12}>
                <Card className="h-100 shadow-sm border-start border-3 border-primary">
                  <Card.Header
                    ...
                    title="Click to view delivery addresses"
                  >
                    <div className="d-flex align-items-center justify-content-between">
                      <div className="d-flex align-items-center">
                        <FaTruck className="text-primary me-2" size={18} />
                        <h6 className="mb-0 fw-semibold text-dark">
                          Delivery Addresses (
                          {customer.customerDeliveryAddress.length})
                        </h6>
                      </div>
                      {isExpand ? (
                        <FaChevronUp className="text-primary" size={16} />
                      ) : (
                  ...
                  {isExpand && (
                    <Card.Body className="p-3">
                      <Row>
                        {customer.customerDeliveryAddress.map(
                          (address, index) => (
