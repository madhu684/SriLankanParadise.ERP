...
import GrnPrintPreview, { useGrnPrint } from "../PrintPreview/GrnPrintPreview";
...
const GrnDetail = ({ show, handleClose, grn }) => {
  ...
  const sellableQuantity = useMemo(() => {
    return totalReceived + totalFree - totalRejected;
  }, [totalReceived, totalFree, totalRejected]);
  ...
  return (
    <>
              ...
              <div className="d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <div className="d-flex gap-3 flex-wrap">
                  ...
                  <small className="text-muted">
                    ...
                    Total Rejected:{" "}
                    <span className="fw-bold text-danger">{totalRejected}</span>
                  </small>
                  <small className="text-muted">
                    <i className="bi bi-gift me-1"></i>
                    Total Free:{" "}
                    <span className="fw-bold text-success">{totalFree}</span>
                  </small>
                  <small className="badge bg-success bg-opacity-10 text-success fw-bold">
      ...
      <GrnPrintPreview
        ...
        grnTypeDisplayMap={grnTypeDisplayMap}
