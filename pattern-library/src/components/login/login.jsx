      ...
      <div className="container-lg">
        <div className="welcome-image text-center">
          ...
          <p className="welcome-description">
            ...
            organization. Our ERP solution integrates different departments and
            functions across your company into a single platform, enhancing
            efficiency, collaboration, and decision-making. Experience the power
            of seamless business management with our advanced ERP system.
          </p>
        </div>
