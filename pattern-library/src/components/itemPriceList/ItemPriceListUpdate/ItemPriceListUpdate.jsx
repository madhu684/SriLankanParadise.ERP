...
import useItemPriceListUpdate from "./useItemPriceListUpdate";
...
const ItemPriceListUpdate = ({ itemPriceList, handleClose }) => {
  const {
    formData,
    statusOptions,
    availableItems,
    ...
    handleRemoveItem,
    handleSubmit,
  } = useItemPriceListUpdate(itemPriceList, handleClose);
...
export default memo(ItemPriceListUpdate);
