...
const PurchaseOrderDelete = ({
  ...
  const handleDeletePO = async () => {
    ...
    try {
      ...
      await delete_purchase_order_api(purchaseOrder.purchaseOrderId);
        ...
        {isDeleted ? (
          <div className="text-center">
            ...
            <p className="text-success fw-bold">
              Purchase Order '{purchaseOrder?.referenceNo}' has been
              successfully deleted!
            </p>
          </div>
        ) : (
          <p>{`Are you sure you want to delete Purchase Order '${purchaseOrder?.referenceNo}' ?`}</p>
        )}
      </Modal.Body>
      <Modal.Footer>
        <Button
