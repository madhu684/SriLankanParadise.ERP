...
import { get_categories_by_company_id_api } from "common/services/inventoryApi";
import {
...
import { get_supplier_logo_api } from "common/services/purchaseApi";
    ...
    try {
      ...
      if (isFormValid) {
        ...
        for (const categoryId of categoriesToAdd) {
          ...
          const categoriesAddApiResponse =
            await post_supplier_category_api(categoryData);
        }
        ...
        if (formData.attachments.length > 0) {
          ...
          for (const attachment of formData.attachments) {
            ...
            const attachmentResponse =
              await post_supplier_attachment_api(uploadData);
