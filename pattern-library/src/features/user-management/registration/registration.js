...
import { get_company_locations_api } from "common/services/purchaseApi.js";
    ...
    try {
      ...
      if (
        ...
        for (const userModuleData of userModulesFromData) {
          ...
          const userModuleResponse =
            await company_subscription_module_user_api(userModuleData);
        ...
        for (const userPermissionData of userPermissionsFromData) {
          ...
          const userPermissionResponse =
            await user_permission_api(userPermissionData);
