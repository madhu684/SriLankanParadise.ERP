...
export const post_item_price_list_api = async (formData) => {
  try {
    const response = await api.post("/itemPriceMaster", formData, {
      withCredentials: true,
    });
    return response.data;
  } catch (error) {
...
export const item_price_list_detail_api = async (formData) => {
  try {
    const response = await api.post("/itemPriceDetail", formData, {
      withCredentials: true,
    });
    return response.data;
  } catch (error) {
...
export const update_item_price_list_master_api = async (id, formData) => {
  try {
    const response = await api.put(`/itemPriceMaster/${id}`, formData, {
      withCredentials: true,
    });
    return response.data;
  } catch (error) {
...
export const update_item_price_detail_list_master_api = async (
  id,
  formData
) => {
  try {
    const response = await api.put(`/itemPriceDetail/${id}`, formData, {
      withCredentials: true,
    });
    return response.data;
  } catch (error) {
...
export const delete_item_price_detail_list_master_api = async (id) => {
  try {
    const response = await api.delete(`/itemPriceDetail/${id}`, {
      withCredentials: true,
    });
    return response.data;
  } catch (error) {
...
export const update_item_price_master_status_api = async (id, formData) => {
  try {
    const response = await api.patch(
      `/itemPriceMaster/ChangeStatus/${id}`,
      formData,
      {
        withCredentials: true,
      }
